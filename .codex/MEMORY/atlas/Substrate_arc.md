...
- Current install patterns: `.codex/rules/Substrate.md`
...
`.codex/rules/Substrate.md` §"Card Installation", `.codex/rules/compute_facades.md`,
`.codex/rules/delta_rule.md` §"Retrieval card install". Auto-generation:
