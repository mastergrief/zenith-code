#!/usr/bin/env python3
"""Post R7 terminal validation receipt to ai-room (real tool_post + witness)."""
...
def post_terminal_to_ai_room(
    ...
    *,
    ...
    post_body = {
        "schema": "hrm_text_158_r7_from_clean_ai_room_terminal_post/v1",
    ...
    witness: dict = {
        "schema": "hrm_text_158_r7_ai_room_post_witness/v1",
        "terminal_receipt_sha256": terminal_sha,
    ...
    handle = operator_handle or os.environ.get("R7_OPERATOR_HANDLE", "test-operator")
    receipt_text = json.dumps(
        {
            "schema": "hrm_text_158_r7_from_clean_terminal_validation_receipt/v1",
            "run_root": str(run_root),
            "primary_branch": terminal.get("primary_branch"),
            "next_action": terminal.get("next_action"),
            "steps_observed": terminal.get("steps_observed"),
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="R7 ai-room terminal post.")
