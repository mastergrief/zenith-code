...
_TEMPLATES_BY_SEMANTIC: Dict[str, List[str]] = {
    "int": [
        ...
        # R18: additional 20 variants
        "Determine whether {arg} is an odd number.",
        "Count the divisors of {arg}.",
        "Return the largest prime factor of {arg}.",
        "Compute the {arg}th triangular number.",
        "Check if {arg} is a Fibonacci number.",
        "Return the hex representation of {arg}.",
        "Convert {arg} to a Roman numeral.",
        "Count the ones in the binary form of {arg}.",
        "Return True if {arg} is a perfect cube.",
        "Compute the {arg}th Catalan number.",
        "Find the least prime larger than {arg}.",
        "Return the digit root of {arg}.",
        "Compute {arg} squared plus {arg}.",
        "Return True if {arg} is divisible by 7.",
        "Count the trailing zeros in {arg}!.",
        "Find the sum of divisors of {arg}.",
        "Return the next prime after {arg}.",
        "Check whether {arg} is a Mersenne number.",
        "Compute the Euler totient of {arg}.",
        "Return the parity (0 or 1) of integer {arg}.",
    ],
    "string": [
        # Original 13
        ...
        # R18: additional 20 variants
        "Count the consonants in string {arg}.",
        "Return the character histogram of string {arg}.",
        "Check whether string {arg} is a valid URL.",
        "Return the longest run of repeated characters in {arg}.",
        "Remove duplicate characters from string {arg}.",
        "Capitalize each word in string {arg}.",
        "Swap the case of every letter in {arg}.",
        "Return the number of uppercase letters in {arg}.",
        "Count the punctuation marks in string {arg}.",
        "Return True if string {arg} is empty.",
        "Strip leading and trailing spaces from {arg}.",
        "Return the words of string {arg} in reverse order.",
        "Check whether string {arg} is a valid Python identifier.",
        "Return the first word of string {arg}.",
        "Return the last word of string {arg}.",
        "Check if string {arg} contains any digits.",
        "Return the middle character of string {arg}.",
        "Count the occurrences of the letter 'a' in {arg}.",
        "Return the set of unique characters in {arg}.",
        "Reverse the order of words in {arg}.",
    ],
    "list": [
        # Original 13
        ...
        # R18: additional 20 variants
        "Return the median of list {arg}.",
        "Compute the standard deviation of list {arg}.",
        "Return every other element of list {arg}.",
        "Check if list {arg} is in strictly increasing order.",
        "Return the number of even elements in list {arg}.",
        "Return the product of all elements in list {arg}.",
        "Flatten a nested list {arg} one level deep.",
        "Return the running max of list {arg}.",
        "Count the negative numbers in list {arg}.",
        "Return True if any element of {arg} is zero.",
        "Filter list {arg} to unique elements.",
        "Return the mode of list {arg}.",
        "Partition list {arg} into evens and odds.",
        "Return the first duplicate element in list {arg}.",
        "Return the kth smallest element of list {arg}.",
        "Compute pairwise differences in list {arg}.",
        "Check whether list {arg} contains any duplicates.",
        "Split list {arg} in half.",
        "Return True if all elements of {arg} are positive.",
        "Compute the range (max minus min) of list {arg}.",
    ],
    "number": [
        ...
        "Return the sign of {arg} (-1, 0, or 1).",
        "Compute the floor of {arg}.",
        "Compute the ceiling of {arg}.",
        "Return {arg} truncated to 2 decimal places.",
        "Check if {arg} is within the range [-100, 100].",
        "Return the negation of {arg}.",
        "Compute the natural log of {arg}.",
        "Return the reciprocal of {arg}.",
        "Return {arg} squared minus one.",
    ...
    "generic": [
        ...
        "Write a function that inspects {arg} and returns its type.",
        "Return a canonical representation of {arg}.",
        "Check if {arg} is empty or None.",
        "Return True when {arg} satisfies a domain-specific constraint.",
        "Return a hash-like fingerprint of {arg}.",
        "Return False if {arg} is invalid, else process it.",
        "Make a deep copy of {arg}.",
    ],
