"""combinations(...) via CALM safe_eval oracle.
...
Capability: parse CombinationsMeta queries, evaluate via CALM safe_eval oracle,
...
class CombinationsMetaFacade:
    ...
    _PARSE_RES = [
        re.compile('combinations\\s*\\(\\s*(-?\\d+)\\s*,\\s*(-?\\d+)\\s*\\)', re.IGNORECASE),
        re.compile('combinations\\s+of\\s+(-?\\d+)\\s+and\\s+(-?\\d+)', re.IGNORECASE),
        re.compile('(-?\\d+)\\s+combinations\\s+(-?\\d+)', re.IGNORECASE),
        re.compile('combinations\\s+(-?\\d+)\\s+(?:by|with|taken)\\s+(-?\\d+)', re.IGNORECASE),
        re.compile('(-?\\d+)\\s+choose\\s+(-?\\d+)', re.IGNORECASE),
    ]
    _EVAL_TEMPLATE = 'combinations({a}, {b})'
