"""Fibonacci(n) via CALM safe_eval oracle.
...
Capability: parse Fibonacci queries, evaluate via CALM safe_eval oracle,
...
class FibonacciFacade:
    ...
    _PARSE_RES = [
        ...
        re.compile('(-?\\d+)(?:st|nd|rd|th)\\s+fibonacci', re.IGNORECASE),
        re.compile('what\\s+is\\s+fib(?:onacci)?\\s+(-?\\d+)', re.IGNORECASE),
    ]
