...
class CombinationsFacade:
    ...
    _PARSE_RES = [
        ...
        re.compile('\\bC\\s*\\(\\s*(-?\\d+)\\s*,\\s*(-?\\d+)\\s*\\)', re.IGNORECASE),
        re.compile('combinations?\\s+of\\s+(-?\\d+)\\s+(?:choose|taken?)\\s+(-?\\d+)', re.IGNORECASE),
        re.compile('combinations?\\s*\\(\\s*(-?\\d+)\\s*,\\s*(-?\\d+)\\s*\\)', re.IGNORECASE),
        re.compile('\\bbinomial\\s+coefficient\\s+of\\s+(-?\\d+)\\s+and\\s+(-?\\d+)', re.IGNORECASE),
    ]
