...
from scripts.hrm_text_158_bounded_delta_acquisition_probe import (
    attach_s3bb_headroom_telemetry_to_step_report as probe_attach_hook,
)
...
def test_w7_phase_writes_nonempty_sidecar_after_warmup(tmp_path: Path) -> None:
...
def test_probe_import_reexports_same_hook() -> None:
    assert probe_attach_hook is attach_s3bb_headroom_telemetry_to_step_report
