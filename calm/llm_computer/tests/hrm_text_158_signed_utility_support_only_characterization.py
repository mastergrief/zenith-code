...
PROGRESS_STEPS = frozenset(("CLI_RECEIPT_RESERVE CLI_PACKET_LOAD CLI_LAUNCH_IDENTITY_BIND CLI_FACADE_LOAD "
    ...
    "MOD_MATERIALIZE MOD_REBUILD_BATCHES MOD_LEAKAGE MOD_FORK_ARMS MOD_CAPTURE_PLANS CAP_COMPUTE_GRADS CAP_VOTE_AUX CAP_SPEC "
    "CAP_APPLY_VOTE_STEP CAP_POST_RETURN_HOLDER_VALIDATION MOD_CHARACTERIZE MOD_VALIDATE_CHARACTERIZATION MOD_ENFORCE_FLOORS MOD_EMIT_TERMINAL CLI_RECEIPT_WRITE").split())
