...
`.claude/MEMORY/atlas/tracing_roadmap_part_1.md` §"TurboQuant Q_prod for KV cache".
...
See `MEMORY/atlas/tracing_roadmap_part_1.md` ruled-out row (Round 53.34) for full
